...
toc: true
tags: database postgres cheatsheet
---
...
can be found in my [github repo](https://github.com/genzade/postGRES){:target="\_blank"}

## Prerequisites

- [`docker`](https://www.docker.com/){:target="\_blank"}
- [`docker-compose`](https://docs.docker.com/engine/reference/commandline/compose/){:target="\_blank"}
- [`pgcli`](https://www.pgcli.com/){:target="\_blank"} (optional, use `psql` or a GUI app of your choice)
...
See all [data types](https://www.postgresql.org/docs/current/datatype.html){:target="\_blank"}.
...
See the [car sql file](https://github.com/genzade/postGRES/blob/main/sql/car.sql){:target="\_blank"}.
...
Check out the [docs](https://www.postgresql.org/docs/16/datatype-datetime.html){:target="\_blank"}
for more.
...
See [person-car.sql file](https://github.com/genzade/postGRES/blob/main/sql/person-car.sql){:target="\_blank"}.
...
We are going to install the [`Universally Unique Identitifiers`](https://en.wikipedia.org/wiki/Universally_unique_identifier){:target="\_blank"} (UUID) extension.
